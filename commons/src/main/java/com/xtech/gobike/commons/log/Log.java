...
import com.xtech.gobike.commons.config.BaseFilePath;
import com.xtech.gobike.commons.exception.XhException;
import com.xtech.gobike.commons.helper.Util;
...
public class Log {
    ...
    private String logDir = BaseFilePath.BASE_LOG_DIR;
    ...
    public void error(XhException ex) {
